<%-- 
    ...
    Created on : 13-sep-2022, 17:59:28
...
<nav class="navbar navbar-expand-lg navbar-light bg-light rounded border border-primary border-2 ">
                    ...
                    <div class="list-group border border-primary border-2 ">
                        <a href="InicioUsuarios.jsp" class="list-group-item list-group-item-action">Inicio</a>
                        <a href="ListadoLibrosUsuarios.jsp" class="list-group-item list-group-item-action">Libros</a>
