<%-- 
    Document   : Prestamos
    Created on : 01/09/2022, 18:32:42
    Author     : User
--%>
...
<link href="Estilos.css" rel="stylesheet" type="text/css"/>
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                                ...
                                                <select class="form-select form-select-sm mb-3" aria-label="Ejemplo de .form-select-lg">
                                                    ...
                                                    <option value="1">Busqueda digital</option>
                                                    <option value="2">Busqueda Fisico</option>
                                                </select>
                                                <select class="form-select form-select-sm mb-3" aria-label="Ejemplo de .form-select-lg">
                                                    <option selected>Todos los campos</option>
                                                    <option value="1">Autor</option>
                                                    <option value="2">Tituo</option>
    ...
    <a href="Reportes.jsp" class="list-group-item list-group-item-action">Reportes</a>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="card">
                                <div class="card-body ">
                                    <form action="Servlet3" class="row g-3">
                                        
                                        <div class="h5" >Datos del prestamo</div>
                                        
                                        
                                        <div class="m-3 row justify-content-evenly">
                                               <div class="col-6">
                                                  
                                                    <label for="inputti" class=" col-form-label">Nro.cedula:</label>
                                                     <input type="tex" class="form-control" id="inputti">  
                                                     
                                                </div>
                                            <div class="col-6">
                                                
                                                    <label for="inputti" class=" col-form-label">Buscar Libro:</label>
                                                     <input type="tex" class="form-control" id="inputti">  
                                        ...
                                        <div class="m-1 row">
                                            <label for="inputti" class=" col-sm-2 col-form-label">Fecha salida:</label>
                                            <div class="col-sm-10">
                                                <input type="tex" class="form-control" id="inputti">
                                            </div>
                                        </div>
                                        <div class="m-1 row">
                                            <label for="inputti" class=" col-sm-2 col-form-label">Fecha devolucion:</label>
                                            <div class="col-sm-10">
                                                <input type="tex" class="form-control" id="inputti">
                                            </div>
                                        </div>
