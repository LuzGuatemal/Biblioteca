<%-- 
    ...
    Created on : 14-sep-2022, 0:52:04
                        ...
                        <div class="col-sm-10">
                            <div class="card">
                                <div class="card-body border border-primary border-2">
                                                ...
                                                <form action="GuardarLibro" method="post" class="row g-3">
                                                    <center>
                                        <div class="col-6 ">
                                                <div class="h4" >REGISTRAR LIBRO</div>
                                            </div>
                                        </center>
                                                            ...
                                                            <div class="input-group m-1 ">
                                                                ...
                                                                <div class="col-sm-4 ">
                                                                    <select name="incluyeCd" class="form-select">
                                                                        <option selected disabled value="">Incluye CD</option>
                                                    ...
                                                    <div class="m-1 row">
                                                        <label  class="col-sm-2 col-form-label">Nro.de paginas:</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" name="nroPaginasM" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="m-1 row">
                                                        <label  class="col-sm-2 col-form-label">Tiempo de vigencia:</label>
                                                        <div class="col-sm-10">
                                                    ...
                                                    <div class="m-1 row">
                                                        <label class="col-sm-2 col-form-label">Año de publicacion:</label>
                                                        <div class="col-sm-6">
