 <%-- 
    Document   : Libros
    Created on : 01/09/2022, 18:32:12
    Author     : User
--%>
                            ...
                            <div class="card">
                                <div class="card-body ">
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-body ">
                                                <form action="Servlet2" class="row g-3">
                                                            ...
                                                            <div class="input-group m-1 ">
                                                                ...
                                                                <div class="col-sm-4 ">
                                                                    <select class="form-select" aria-label="Default select example">
                                                                        <option selected>Incluye CD</option>
                                                    ...
                                                    <div class="m-1 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="tex" class=" col-sm-2 form-control" id="inputti">
                                                        </div>
                                                    </div>
                                                    <div class="m-1 row">
